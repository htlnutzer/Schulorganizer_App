...
public class AddContentText extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_content_text);
        ...
        if(type != null){
            ((TextView)findViewById(R.id.tbText)).setText(old);
        }
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("OLD",old);
                String newText = ((EditText)findViewById(R.id.tbText)).getText().toString();
